...
- [x] CLAUDE.md очищен от дублей (89 КБ → 56 КБ, –38%)
- [x] PROGRESS.md обновлён со статусами и новыми блоками 47-68

---

## Статистика

**Всего блоков**: 76 (включая под-блоки 1.5, 2.5, 5.5, 6a/b/c/d, 12.5, 16.5)
...
| ⬜ Не начато | 50 | Всё остальное (включая Блок 5 — главный gap) |

**Прогресс по реальному коду** (½ + ¼ + ✅): **~34%** (26 из 76)
**Прогресс по «боевому» состоянию** (только ✅): **~4%** (3 из 76)
