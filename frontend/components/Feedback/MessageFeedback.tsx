...
export default function MessageFeedback({
  ...
  const handleClick = async (kind: "up" | "down") => {
    ...
    try {
      ...
      // Тихо игнорируем — не показываем ошибку пользователю.
      // Рационал: feedback не критичен для основного потока,
      // и не хочется напрягать пользователя автоматическими ретраями.
    }
  };
